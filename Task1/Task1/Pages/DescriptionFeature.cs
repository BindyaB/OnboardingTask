...
namespace Task1.Pages
{
    public class DescriptionFeature
    {
        ...
        {
            WaitHelpers.WaitToBeClickable(driver, "XPath", "/html/body/div[1]/div/section[2]/div/div/div/div[3]/div/div/div/h3/span/i", 3);
            ...
            Console.WriteLine(descText.Text);

            if (descText.Text == "Hi, I am a ballet dancer wanting to share my skills on this medium. I am a great ballet dancer and I can teach kids or grown ups of any age.")
            {
